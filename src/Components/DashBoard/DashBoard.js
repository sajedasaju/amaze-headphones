    ...
    return (
        <div className='container mx-auto'>
            <div className='grid md:grid-cols-2 sm:grid-cols-1 mt-10 '>
                <div>
                    <h2 className='text-2xl  text-left font-serif font-bold my-4 text-red-700'>Month Vs Sell</h2>
                ...
                <div>
                    <h2 className='text-2xl  text-left font-serif font-bold mt-4 text-red-700'>Investment Vs Revenue</h2>
                ...
                <div>
                    <h2 className='text-2xl  text-left font-serif font-bold my-4 text-red-700'>Investment Vs Revenue</h2>
                    <BarChart
                        width={300}
                        height={300}
                        data={data}
